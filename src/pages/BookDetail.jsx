                ...
                <div>
                    ...
                    <div class="stats border border-base-300 flex mt-3">
                        <div class="stat">
                            ...
                            <div className='flex gap-3'>
                                <div class="stat-value">How to become a billionaire in a week</div>
                            </div>
                            ...
                            <div className='mt-5 flex gap-2'>
                                <button className="btn btn-circle btn-soft btn-warning">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.8" stroke="currentColor" class="size-6">
